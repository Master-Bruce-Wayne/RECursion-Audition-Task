...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-purple-950 to-purple-900 border-t border-purple-800/50">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-2">
                ...
                <path d="M20 15 L23 20 L28 20 L24 24 L25 30 L20 27 L15 30 L16 24 L12 20 L17 20 Z" fill="white"/>
                <defs>
              ...
              <h3 className="text-2xl font-bold text-white">Game-Maniac</h3>
            </div>
            <p className="text-purple-200 mb-4 max-w-md">
              Your ultimate destination for thousands of exciting games. Play, compete, and win!
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/games" className="text-purple-200 hover:text-white transition-colors">
                  Games
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/register" className="text-purple-200 hover:text-white transition-colors">
                  Sign Up
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-purple-800/50 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-purple-300 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Game-Maniac. All rights reserved.
          </p>
